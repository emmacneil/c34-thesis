...
\usepackage[style=numeric, maxbibnames=99, backend=biber]{biblatex}
\bibliography{biblio}
...
\include{chapter-c34-curves}
\include{chapter-groebner-bases}  
\include{chapter-differentials}
\include{chapter-divisors}
\include{chapter-ideals}
\include{chapter-representation}
\include{chapter-addition}
\include{chapter-doubling}
\include{chapter-reduction}
\include{chapter-typical-case}
...
\include{appendix-colon-ideal}
\include{appendix-reduced-divisors}
%\include{appendix-formulae}
