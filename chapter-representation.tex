...
\subsection{Types 31, 41, 51, and 61}
\label{sec_types_31_41_51_61}

\note{
Later in the thesis, particularly in Chapters \ref{chap_doubling} and \ref{chap_reduction},
I make reference to cases where
$\pid{f,g,h} = \pid{f,g}$,
$\pid{f,g} \neq \pid{f,g,h} = \pid{f,h}$,
and $\pid{f,g} \neq \pid{f,g,h} \neq \pid{f,h}$.
Put some notes here about how one is able to distinguish between these cases.
Briefly, there exist polynomials $r, s, r', t'$ and constants $s'_0, t_0$ such that
\[ fr + sg = t_0h \]
and
\[ fr' + s'_0g = t'h. \]
These cases are recognizable by whether the constants $s'_0$ and $t_0$ are zero or non-zero.
}
