...
\end{proof}
See \cite{hungerford} for a definition of cokernel and coimage.
...
To determine the image of $d$, it is enough to know the image of the element $C \in \pid C / \pid{C^2}$.
