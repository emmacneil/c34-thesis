...
where I, M, S, A refer to the number of inversions, multiplications, squarings, and additions in a finite field
...
Combining these operations saves an expensive inversion operation and several additions at the cost of some multiplications.
